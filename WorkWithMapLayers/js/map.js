...
require([
    ...
    function (Map,
              ready, parser, on,
              BorderContainer, ContentPane,TabContainer, Extent,ArcGISDynamicMapServiceLayer,FeatureLayer,BasemapToggle,Legend,BasemapGallery,
              dom, Color, keys,
...
*/
            ...
            mapMain.on("layers-add-result", union2 );
...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            mapMain.on("load", loadTable);

            function loadTable(){

                // editable FeatureLayer
                var myFeatureLayer = new FeatureLayer("http://localhost:6080/arcgis/rest/services/MiniProjet/BidonvillesFinal/FeatureServer/0", {
                    mode: FeatureLayer.MODE_ONDEMAND,
                    outFields: ["*"],
                    infoTemplate : ptQuakes,
                    visible: true,
                ...
                mapMain.addLayer(myFeatureLayer);
                    ...
                    menuFunctions: [
                        {
                            ...
                            callback: function(evt){
                                ...
                                myFeatureLayer.setDefinitionExpression("Etat = NP");
